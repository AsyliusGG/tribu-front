    ...
    <div className="relative h-screen overflow-hidden">
      ...
      <div className="flex justify-center items-center h-full overflow-hidden bg-gray-100 bg-opacity-75 p-4 relative z-10">
        <div className="w-full max-w-5xl mx-auto p-4" style={{ margin: '5%' }}>
          ...
          >
            <p className="text-gray-800 bg-pink-100 p-4 rounded-t-lg text-lg leading-relaxed">
            ...
            <p className="text-gray-800 bg-pink-100 p-4 text-lg leading-relaxed">
            ...
            {/* Separación del <ol> */}
            <div className="text-gray-800 bg-pink-100 p-4 text-lg leading-relaxed">
            ...
            <p className="text-gray-800 bg-pink-100 p-4 rounded-b-lg text-lg leading-relaxed">
